...
public class TurtlePond implements KeyEventDispatcher {
	...
	private void checkForFood() throws Exception {
		...
		if (Math.abs(tortoiseLocationX - cookieX) < 5 && Math.abs(tortoiseLocationY - cookieY) < 5) {
			JOptionPane.showMessageDialog(null, "Good job! You found the cookie.");
		}
		// 11. If more than 20 seconds have elapsed, tell them the turtle died of hunger!
		if (getTimeElapsed() > 20) {
			JOptionPane.showMessageDialog(null, "Your turtle died of hunger.");
			System.exit(0);
		}
