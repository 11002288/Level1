...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		JPanel panel = createHeader("Music");
	...
	/*
	 * 13. Use the method provided to play the Jeopardy theme music playjeopardyTheme() 14. Add buttons so that you have
	 * $200, $400, $600, $800 and $1000 questions
	 *
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		String stuff = JOptionPane.showInputDialog(question);
